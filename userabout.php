...
<head>
    ...
    <title>About Us - Sticker Runners</title>
...
<?php include ('session.php');?>
    ...
    <div class="mid">
        <br><br>
        <h1>Our Story</h1>
        <img src="image/owner.webp" alt="">
        <p>Hello and welcome to Sticker Runners, the place to find the best Clothing for every taste and occasion. We thoroughly check the quality of our goods, working only with reliable suppliers so that you only receive the best quality product.

            We at Sticker Runners believe in high quality and exceptional customer service. But most importantly, we believe shopping is a right, not a luxury, so we strive to deliver the best products at the most affordable prices, and ship them to you regardless of where you are located.</p>
    </div>
    <div class="footer">
        <br>
        <div class="icon">
