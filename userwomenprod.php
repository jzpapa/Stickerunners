...
<head>
    ...
    <link rel="stylesheet" href="womenprodstyle.css">
</head>
<body>
<?php include ('session.php');?>
    ...
    <div class="mid">
        <div class="categories">
            <nav>
                <ul>
                    <li id="all"><a href="userproduct.php"> All products </a></li>
                    <li id="men"><a href="usermenprod.php">Men's Clothing</a></li>
                    <li id="women"><a href="">Women's Clothing</a></li>
	...
	include("includes/database.php");
			$query=mySQLi_query($con,"SELECT * from item WHERE category='women'");
